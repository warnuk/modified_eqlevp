subroutine eql (label, temp, dens, ph, na, k, li, ca, mg, cl, so4, alk, no3, si, b, pc)
	...
	character (len=maxlen), intent(in)  :: temp, dens, ph, na, k, li, ca, mg, cl, so4, alk, no3, si, b, pc
	real(kind=8), intent(in)  :: temp, dens, ph, na, k, li, ca, mg, cl, so4, alk, no3, si, b, pc
